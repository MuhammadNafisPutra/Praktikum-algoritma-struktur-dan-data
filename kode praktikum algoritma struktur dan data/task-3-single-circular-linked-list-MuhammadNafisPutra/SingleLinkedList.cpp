...
int main()
{
        ...
        switch(pil) {
            ...
            case 3:
                hapusDepan();
                cout<<"Data \""<<isi<<"\" yang berada di depan telah berhasil dihapus."<<endl;
                break;
            case 4:
                hapusBelakang();
                cout<<"Data \""<<isi<<"\" yang berada di belakang telah berhasil dihapus."<<endl;
                break;
            case 5:
                tampilkan();
                break;
            ...
            default:
                cout<<"\nTERIMA KASIH"<<endl;
                cout<<"Program was made by Nafis (2410817210021)."<<endl;
        }
        ...
        void cariData() {
            if(isEmpty() == 0) {
                ...
                bool apaDitenukan = false;

                bantu = head;
        
                do {
                    if(cari == bantu->data) {
                        cout<<"===> Data yang berada di dalam tanda kurung siku ([...]) ="
                ...
                if(apaDitenukan == false) 
                    cout<<"Data "<<cari<<" tidak ditemukan pada Linked List."<<endl;
               } else cout<<"Tidak terdapat data dalam Linked List."<<endl; 
            }
        ...
        void hapusData() {
            if (isEmpty() == 0) {
                ...
                if (apaDitemukan == true) {
                    ...
                    } else cout <<"Data \""<<cari<<"\" tidak dapat ditemukan pada Linked List."<<endl;
